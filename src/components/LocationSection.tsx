...
const LocationSection: React.FC<LocationSectionProps> = ({
  ...
  return (
    <section className="w-full px-0 sm:px-0 md:px-6 lg:px-0 xl:px-12 2xl:px-16 flex flex-col items-center justify-center z-10 relative py-4 md:py-8">
      <div className="flex flex-col items-center justify-center w-full max-w-[1380px] mx-auto gap-6 sm:gap-8 md:gap-10 lg:gap-12 xl:gap-14 2xl:gap-16">
        {/* Title */}
        <h2
          className={`text-[#2B0B1F] text-center mb-4 sm:mb-6 font-roc ${className}`}
          style={{
        ...
        {/* Content Section - Stacks vertically on mobile/tablet, horizontal on desktop */}
        <div className="flex flex-col lg:flex-row gap-8 sm:gap-10 md:gap-12 lg:gap-14 xl:gap-10 w-full lg:max-w-[90%] xl:max-w-[80%]">
          {/* Address */}
          <div className="text-center lg:text-left flex items-center justify-center lg:justify-start w-full lg:w-[45%]">
            <div
              className={`font-roc font-normal ${className} mt-5 flex flex-col items-center lg:items-start w-full max-w-[400px]`}
              style={{
          ...
          {/* Contact Information */}
          <div className="flex flex-col items-center lg:items-start justify-center lg:w-[55%]">
            {/* Phone Numbers */}
              ...
              <div className="flex flex-col -mb-8 w-full">
                {emails.info && (
                  <a 
                    ...
                    className="flex items-center justify-center lg:justify-start hover:opacity-80 transition-opacity mb-2"
                  >
                    <svg 
                      className="w-5 h-5 mr-2 flex-shrink-0" 
                      fill={iconColor}
                ...
                {emails.globalConnect && (
                  <div className="flex flex-col w-full">
                    <span
                      className={`font-roc font-normal ${className} mb-1 text-center lg:text-left`}
                      style={{
