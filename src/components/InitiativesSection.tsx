...
export default function InitiativesSection() {
  return (
    <div className="w-full flex flex-col items-center">
      ...
      <p className="text-[#FFFFFF] text-clamp-28 text-justify px-6  md:px-32 lg:px-48 xl:px-64">
      ...
      <div className="w-full px-4 sm:px-8 md:px-10 lg:px-12 xl:px-24  md:my-8 my-12">
