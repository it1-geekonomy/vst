      ...
      >
       <h2 className="text-white text-6xl mb-24 text-center">
        ...
        <div className="flex justify-center items-center gap-4 sm:gap-6 md:gap-8 lg:gap-20">
          <button className="text-white md:block hover:opacity-100 transition-opacity absolute left-4">
          ...
          <button className="text-white md:block hover:opacity-80 transition-opacity absolute right-4">
            {/* Increased arrow size */}
            <svg
              className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 lg:w-12 lg:h-12"
              fill="none"
