...
import Tractor1 from '@/app/public/images/Manufacture/Tractor.png'
import Tractor2 from '@/app/public/images/Manufacture/Tractor.png'
import Tractor3 from '@/app/public/images/Manufacture/Tractor.png'
import Tractor4 from '@/app/public/images/Manufacture/Tractor.png'
      ...
      <div className="mx-auto px-4 md:px-8 lg:px-12 pb-12 flex flex-col justify-around w-[95%] md:w-[98%]">
        ...
        <div className="px-0">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-8 md:gap-16 w-full">
            ...
            <div className="flex-1 w-full md:max-w-[48%] flex flex-col">
              {/* Image Container */}
              <div 
              ...
              >
                ...
                <button
                  onClick={() => setCurrentImage((prev) => (prev - 1 + tractorImages.length) % tractorImages.length)}
                  className="hidden md:block absolute left-2 top-1/2 -translate-y-1/2 bg-black/30 text-white rounded-full p-2 hover:bg-black/50 transition-colors"
                ...
                <button
                  onClick={() => setCurrentImage((prev) => (prev + 1) % tractorImages.length)}
                  className="hidden md:block absolute right-2 top-1/2 -translate-y-1/2 bg-black/30 text-white rounded-full p-2 hover:bg-black/50 transition-colors"
              ...
              {/* Navigation Dots - Make more touch-friendly on mobile */}
